...
<body class="bg-gray-200">
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-100" style="background-image: url('{{ asset('assets/img/imagen_login.avif')}}');">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('login') }}" role="form" class="text-start">
                                    ...
                                    <div class="form-check form-switch d-flex align-items-center mb-3">
                                        ...
                                        <label class="form-check-label mb-0 ms-2" for="rememberMe">Recordar datos</label>
                                    </div>
                                    <div class="text-center">
                                        <button class="btn bg-gradient-primary w-100 my-4 mb-2">Iniciar</button>
                                    </div>
                                    <p class="mt-4 text-sm text-center">
                                        Olvidaste tu contraseña?
                                        <a href="{{ route('password.request') }}" class="text-primary text-gradient font-weight-bold">Recuperala</a>
                                    </p>
                                </form>
                            </div>
                        </div>
