                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-uppercase text-center ps-3">DEPARTAMENTOS REGISTRADOS</h6>
                            </div>
                        </div>
                        <div class="row">
                                            ...
                                            @foreach ($departamentos as $departamento)
                                                <tr>
                                                    <td class="td-actions text-center">
                                                        ...
                                                        <button
                                                            wire:click.prevent="$emit('destroyDepartamento', {{ $departamento->id }})"
                                                    ...
                                                    <td style="padding-left: 25px">{{ $departamento->id }}</td>
                                                    <td style="padding-left: 25px">{{ $departamento->name }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
...
@push('mijs')
    ...
    <script>
        // destroyDepartamento es el nombre del metodo del boton ---- departamento_id nombre del parametro que pasamos en la confirmacion de mas abajo
        Livewire.on('destroyDepartamento', departamento_id => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // departamentos es el nombre de la vusta o el nombre que esta en render creo----- destroy el metodo del controlador--- departamento_id el que pasamos al inicio de este script
                    Livewire.emitTo('departamentos', 'destroy', departamento_id)
                    Swal.fire({
                        position: 'center',
                        icon: 'success',
